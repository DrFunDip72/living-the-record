...
var levels: Array = [
	...
	},
	{
		...
		"lose_text": "The flock scattered. Ammon's whole standing with the king rested on defending what was entrusted to him.\n\nTry again -- make every stone count.",
