...
var levels: Array = [
	{
		...
		"description": "You are one of Helaman's stripling warriors. March with your captain through eight waves -- flank attacks, brutes, skirmishers, and a final charge. Hold your place in the line; your brothers fight harder when you do.",
		"icon": "swords",
